/datum/virtue/origin/reach
	name = "Reachmen"
	desc = "I originate from Scarlet Reach."
	restricted = TRUE
	...
	origin_desc = "An independent domain sandwiched between Otava and Grenzelhoft, positioned the eastern edge of the Greywall mountain range. Scarlet Reach sits on a key \
	...
	Scarlet Reach still enjoys a tentative position of neutrality. Both countries are currently locked in a stalemate, as neither the Patriarch of Otava nor the Emperor \
	of Grenzelhoft are willing to see open war break out."

/datum/virtue/origin/grenzelhoft
	name = "Grenzelhoftian"
	desc = "I originate from Grenzelhoft."
	restricted = TRUE
	restricted_races = list(/datum/species/elf/dark,
							/datum/species/halforc,
							/datum/species/tabaxi,
							/datum/species/goblinp
)
	origin_desc = "Believed to be the birthplace of humanity, the Grenzelhoft region is steeped in tradition and history. Loosely organized under Emperor Kövel II, the \
	...
	principalities which vie for control over the Imperial electorate. Grenzelhoft is unique in that it maintains a professional army, funded by contracting its soldiers \
...
/datum/virtue/origin/etrusca
	...
	origin_desc = "An archipelago of maritime city-states located off the eastern coast of the Otavan countryside. Etrusca is not one unified state, existing instead as \
...
/datum/virtue/origin/otava
	name = "Otavan"
	desc = "I originate from Otava."
	restricted = TRUE
	restricted_races = list(/datum/species/golem/metal,
							/datum/species/halforc,
							/datum/species/goblinp
)
	origin_desc = "A religious union of duchies and counties who answer to the Patriarch of the Otavan Archdiocese. Otava is a deeply devout country and exists as a \
	...
	slavery centuries ago during the Psydonian Renewal, but lasting effects can still be seen in Otavan society. While Otava is populated by all manner of races, the \
	...
	revival in the schism. The unsanctioned use of magic is illegal in Otava, punishable by branding and the removal of one's tongue."

/datum/virtue/origin/gronn
	name = "Gronnic"
	desc = "I originate from Gronn."
	restricted = TRUE
	restricted_races = list(/datum/species/elf/dark,
							/datum/species/akula,
							/datum/species/tabaxi,
	...
	origin_desc = "A tribal confederation of northmen and half-orcs nestled in the Skol River Valley. Centuries of war between humen and orcs have stained these grassy \
	...
	time, the skirmishes between these loosely-aligned tribes has brought its own form of assimilation. Full-blooded orcs are exceedingly rare in the modern day, and it \
...
/datum/virtue/origin/raneshen
	name = "Ranesheni"
	desc = "I originate from Raneshen."
	restricted = TRUE
	restricted_races = list(/datum/species/elf/dark,
							/datum/species/halforc,
							/datum/species/goblinp,
	...
	origin_desc = "Home to the zealous sun elves, the region of Raneshen sits at the gateway between the East and West. Its lands were once ruled by the Solarin, a divine \
	...
	between Astratan and Psydonians is even more widespread in Raneshen than it is in the West. The region itself is known for lush river-valleys, with lethally-hot \
...
/datum/virtue/origin/naledi
	...
	origin_desc = "When the Tennite faith first swept through the world many centuries ago, the people of Naledi were left entirely untouched. Though knowledge of PSYDON \
	...
	rich in gold, and that its people look to the stars for divine knowledge of our world. It is rumored that the Naledi Emir is over five hundred years old, owing his \
	long lifespan to closely-guarded alchemical secrets."

/datum/virtue/origin/kazengun
	name = "Kazengunite"
	desc = "I originate from Kazengun."
	restricted = TRUE
	restricted_races = list(/datum/species/elf/dark,
							/datum/species/halforc
)
...
/datum/virtue/origin/hammerhold
	name = "Hammerholdian"
	desc = "I originate from Hammerhold."
	restricted = TRUE
	restricted_races = list(/datum/species/elf/dark,
							/datum/species/tabaxi,
							/datum/species/moth
